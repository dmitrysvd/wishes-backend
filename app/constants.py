...
# Общий выключатель пушей по складу (0013). Выключен решением продукта: Android
# в сторе ещё без 0011 — без плашки цены пуш «подешевела» ведёт на карточку,
# которая не объясняет цифру. При False крон не считает, не шлёт, не пишет лог
# и не двигает базу «видел» — база начнёт жить с первого включённого обхода.
# Включать отдельным PR по команде владельца после выкладки Android с 0011.
# Ручка /push/opened и миграции живут независимо от флага.
