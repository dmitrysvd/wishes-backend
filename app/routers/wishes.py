...
def refresh_store_price(
    ...
    Сайд-эффект для пушей по складу (фича 0013): после успешного ответа магазина
    юзер «видел» новую цену — база порога «подешевело» сдвигается на неё, и
    следующий пуш придёт только при падении ещё на ≥ 10% от этой цены.
